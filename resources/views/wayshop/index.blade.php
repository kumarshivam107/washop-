                        ...
                        <div class="filter-sidebar-left">
                            ...
                            @foreach($category as $cat)
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men1"  data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$cat->category_name}}
								</a>
                                    <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                        <div class="list-group">
                                            @foreach($cat->category as $subcat)
                                            <a href="{{url('/categorylist/'.$subcat->id)}}" class="list-group-item list-group-item-action active">{{$subcat->category_name}}</a>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li><a href="{{url('/productdetail/'.$product->sno)}}" data-toggle="tooltip" data-placement="right" title="View"><i class="fa fa-eye"></i></a></li>
                                                            <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="fa fa-heart"></i></a></li>
                                                        </ul>
                                                        <a class="cart" href="{{url('/productdetail/'.$product->sno)}}">Product Details</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            ...
                            <ul class="option-blog">
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="Likes"><i class="fa fa-thumbs-up" style="font-size:24px"></i></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="Views"><i class="fa fa-eye" style="font-size:24px"></i></a></li>
                                <li><a href="#" data-toggle="tooltip" data-placement="right" title="Comments"><i class="fa fa-comments-o" style="font-size:24px"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
