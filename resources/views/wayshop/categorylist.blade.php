                        ...
                        <div class="filter-sidebar-left">
                            ...
                            @foreach($category as $cat)
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men1"  target="blank" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{$cat->category_name}}
								</a>
