...
@section('content')
    ...
    <div class="contact-box-main">
        <div class="container">
         ...
         <div class="col-lg-1 col-sm-12 text-center" id="or">
          <button class="btn btn-danger btnn " style="margin-top:20vh;!important">OR </button>
         </div>
            ...
            <div class="contact-form-right">
                ...
                <form action="{{url('/user-login')}}" method="post" id="contactForm LoginForm"> {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                               <input type="email" class="form-control" placeholder="Your Email" id="uemail" name="uemail" required data-error="Please Enter Your Email">
                               <div class="help-block with-errors"></div>
                           </div>
